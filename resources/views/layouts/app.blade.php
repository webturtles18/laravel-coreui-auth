        ...
        <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
            <div class="sidebar-brand d-none d-md-flex">
                <svg class="sidebar-brand-full" width="118" height="46" alt="CoreUI Logo">
                    <use xlink:href="assets/brand/coreui.svg#full.svg"></use>
                </svg>
                <svg class="sidebar-brand-narrow" width="46" height="46" alt="CoreUI Logo">
                    <use xlink:href="assets/brand/coreui.svg#signet.svg"></use>
                </svg>
            </div>
            <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
                <li class="nav-item"><a class="nav-link" href="index.html">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-speedometer.svg"></use>
                        </svg> Dashboard<span class="badge badge-sm bg-info ms-auto">NEW</span></a></li>
                <li class="nav-title">Theme</li>
                <li class="nav-item"><a class="nav-link" href="colors.html">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-drop.svg"></use>
                        </svg> Colors</a></li>
                <li class="nav-item"><a class="nav-link" href="typography.html">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-pencil.svg"></use>
                        </svg> Typography</a></li>
                <li class="nav-title">Components</li>
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-puzzle.svg"></use>
                        </svg> Base</a>
                ...
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-cursor.svg"></use>
                        </svg> Buttons</a>
                    <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link" href="charts.html">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-chart-pie.svg"></use>
                        </svg> Charts</a></li>
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-notes.svg"></use>
                        </svg> Forms</a>
                    <ul class="nav-group-items">
                ...
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-star.svg"></use>
                        </svg> Icons</a>
                    <ul class="nav-group-items">
                ...
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-bell.svg"></use>
                        </svg> Notifications</a>
                    <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link" href="widgets.html">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-calculator.svg"></use>
                ...
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                    ...
                    <ul class="nav-group-items">
                        <li class="nav-item"><a class="nav-link" href="login.html" target="_top">
                                <svg class="nav-icon">
                                    <use xlink:href="assets/icons/free/cil-account-logout.svg"></use>
                                </svg> Login</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="404.html" target="_top">
                                <svg class="nav-icon">
                                    <use xlink:href="assets/icons/free/cil-bug.svg"></use>
                                </svg> Error 404</a></li>
                ...
                <li class="nav-item mt-auto"><a class="nav-link" href="https://coreui.io/docs/templates/installation/" target="_blank">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-description.svg"></use>
                        </svg> Docs</a></li>
                <li class="nav-item"><a class="nav-link nav-link-danger" href="https://coreui.io/pro/" target="_top">
                        <svg class="nav-icon">
                            <use xlink:href="assets/icons/free/cil-layers.svg"></use>
                        </svg> Try CoreUI
                ...
                <div class="container-fluid">
                    <button class="header-toggler px-md-0 me-md-3" type="button" onclick="coreui.Sidebar.getInstance(document.querySelector('#sidebar')).toggle()">
                        <svg class="icon icon-lg">
                            <use xlink:href="assets/icons/free/cil-menu.svg"></use>
                        </svg>
                    ...
                    <ul class="header-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">
                                <svg class="icon icon-lg">
                                    <use xlink:href="assets/icons/free/cil-list-rich.svg"></use>
                                </svg></a></li>
                        <li class="nav-item"><a class="nav-link" href="#">
                                <svg class="icon icon-lg">
                                    <use xlink:href="assets/icons/free/cil-envelope-open.svg"></use>
                                </svg></a></li>
                    </ul>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-end pt-0">
                                <div class="dropdown-header bg-light py-2">
                                    ...
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-task.svg"></use>
                                    </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item" href="#">
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-comment-square.svg"></use>
                                    </svg> Comments<span class="badge badge-sm bg-warning ms-2">42</span></a>
                                <div class="dropdown-header bg-light py-2">
                                    <div class="fw-semibold">Settings</div>
                                </div><a class="dropdown-item" href="#">
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-user.svg"></use>
                                    </svg> Profile</a><a class="dropdown-item" href="#">
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-settings.svg"></use>
                                    </svg> Settings</a><a class="dropdown-item" href="#">
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-credit-card.svg"></use>
                                    </svg> Payments<span class="badge badge-sm bg-secondary ms-2">42</span></a><a class="dropdown-item" href="#">
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-file.svg"></use>
                                    </svg> Projects<span class="badge badge-sm bg-primary ms-2">42</span></a>
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                                    <svg class="icon me-2">
                                        <use xlink:href="assets/icons/free/cil-lock-locked.svg"></use>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                                    ...
                                    <button class="btn btn-primary" type="button">
                                        <svg class="icon">
                                            <use xlink:href="assets/icons/free/cil-cloud-download.svg"></use>
                                        </svg>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card mb-4" style="--cui-card-cap-bg: #3b5998">
                                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                                    <svg class="icon icon-3xl text-white my-4">
                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-facebook-f.svg"></use>
                                    </svg>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card mb-4" style="--cui-card-cap-bg: #00aced">
                                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                                    <svg class="icon icon-3xl text-white my-4">
                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-twitter.svg"></use>
                                    </svg>
                                    <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card mb-4" style="--cui-card-cap-bg: #4875b4">
                                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                                    <svg class="icon icon-3xl text-white my-4">
                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-linkedin.svg"></use>
                                    </svg>
                                    <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="progress-group mb-5">
                                                <div class="progress-group-header">
                                                    <svg class="icon icon-lg me-2">
                                                        <use xlink:href="assets/icons/free/cil-user-female.svg"></use>
                                                    </svg>
                                                    <div>Female</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header">
                                                    <svg class="icon icon-lg me-2">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-google.svg"></use>
                                                    </svg>
                                        ...
                                        <table class="table border mb-0">
                                            ...
                                            <tr class="align-middle">
                                                <th class="text-center">
                                                    <svg class="icon">
                                                        <use xlink:href="assets/icons/free/cil-people.svg"></use>
                                                    </svg>
                                                </th>
                                                <th>User</th>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/flag.svg#cif-us.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-mastercard.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <button class="btn btn-transparent p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <svg class="icon">
                                                                <use xlink:href="assets/icons/free/cil-options.svg"></use>
                                                            </svg>
                                                        </button>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/flag.svg#cif-br.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-visa.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="small text-medium-emphasis">Last login</div>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/flag.svg#cif-in.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-stripe.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="small text-medium-emphasis">Last login</div>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/flag.svg#cif-fr.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-paypal.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="small text-medium-emphasis">Last login</div>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/flag.svg#cif-es.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-apple-pay.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="small text-medium-emphasis">Last login</div>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/flag.svg#cif-pl.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="clearfix">
                                                ...
                                                <td class="text-center">
                                                    <svg class="icon icon-xl">
                                                        <use xlink:href="vendors/@coreui/icons/svg/brand.svg#cib-cc-amex.svg"></use>
                                                    </svg>
                                                </td>
                                                <td>
                                                    <div class="small text-medium-emphasis">Last login</div>
